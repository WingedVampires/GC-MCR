...
import edu.tamu.aser.constraints.ConstraintsFilter;
...
//        System.out.println(MAX_NUM_THREADS_IN_A_SCHEDULE + maxNumThreads);
        ...
        System.out.println("SMT_FILE_NUMBER: " + ConstraintsFilter.totalConstraintsCounts);
        System.out.println("FILTER_SMT_NUMBER: " + ConstraintsFilter.filtedConstraintsCounts);
        if (failureDetected) {
...
//        System.err.println(MCRProperties.SCHEDULING_REPRO_CHOICES_KEY + "=" + choicesMade + "\n");
    ...
    private String getDurationString(long milliSecs) {
        ...
        return String.format("%d:%02d:%02d  + %02d milli sec = %02d milli sec", hours, mins, secs, milli, milliSecs);
